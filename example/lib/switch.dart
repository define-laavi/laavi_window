...
auto lw = bitsdojo_window_configure(LW_CUSTOM_FRAME | LW_HIDE_ON_STARTUP);

*/

import 'package:flutter/material.dart';
import 'package:laavi_window/laavi_window.dart';
...
class RightSideTopArea extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WindowTitleBarBox(
        child: Row(children: [Expanded(child: MoveWindow())]));
  }
}
